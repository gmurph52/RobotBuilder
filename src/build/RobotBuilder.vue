<template>
  <div class="content">
    ...
    <div class="top-row">
      <div :class="[saleBoarderClass, 'top', 'part']">
        <div class="robot-name">
          {{ selectedRobot.head.title }}
          <span v-if="selectedRobot.head.onSale" class="sale">Sale!</span>
        </div>
        <img :src="selectedRobot.head.imageUrl" alt="head" />
        <button @click="selectPrviouseHead()" class="prev-selector">&#9668;</button>
    ...
    <div class="middle-row">
      <div class="left part">
        ...
        <button @click="selectPrviouseLeftArm()" class="prev-selector">&#9650;</button>
        <button @click="selectNextLeftArm()" class="next-selector">&#9660;</button>
      </div>
      <div class="center part">
        <img :src="selectedRobot.torso.imageUrl" alt="torso" />
        <button @click="selectPrviouseTorso()" class="prev-selector">&#9668;</button>
        <button @click="selectNextTorso()" class="next-selector">&#9658;</button>
      </div>
      <div class="right part">
        <img :src="selectedRobot.rightArm.imageUrl" alt="right arm" />
        <button @click="selectPrviouseRightArm()" class="prev-selector">&#9650;</button>
    ...
    <div class="bottom-row">
      <div class="bottom part">
        ...
        <button @click="selectPrviouseBase()" class="prev-selector">&#9668;</button>
...
const saleBoarderClass = computed(() => (selectedRobot.value.head.onSale ? 'sale-border' : ''));
